...
switch nom
    ...
    case 'model_TRA_1'
        %------------------------------------------------------------------
        % Trajectoire simple pour vehicule lent
        %------------------------------------------------------------------

        % Sequence des consignes de vitesse: date[s], vitesse[m/s]
        consVIT = [];
        consVIT = [consVIT;[   0   0  ]];
        consVIT = [consVIT;[   5   5  ]];
        
        % Sequence des consignes de braquage: date[s], braquage[°]
        consPHI = [];
        consPHI = [consPHI;[   0   0  ]];
        consPHI = [consPHI;[  20   4  ]];
        consPHI = [consPHI;[  30   0  ]];
        consPHI = [consPHI;[  60   3  ]];
        consPHI = [consPHI;[  70   0  ]];
        consPHI = [consPHI;[ 100   3  ]];
        consPHI = [consPHI;[ 110   0  ]];
        consPHI = [consPHI;[ 140   3  ]];
        consPHI = [consPHI;[ 150   0  ]];
        consPHI = [consPHI;[ 160   3  ]];
        consPHI = [consPHI;[ 170   0  ]];
    ...
    case 'model_TRA_2'
        %------------------------------------------------------------------
        % Trajectoire complexe pour vehicule lent
        %------------------------------------------------------------------
